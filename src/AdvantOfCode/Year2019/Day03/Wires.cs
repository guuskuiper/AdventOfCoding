namespace AdventOfCode.Year2019.Day03
{
    public class Wires
    {
        ...
        public int MinManhattanDist = int.MaxValue;
        public int MinTotDist = int.MaxValue;
        ...
        private Pos2 Draw(Pos2 from, Wire wirePart)
        {
            ...
            for(int i = 0; i < wirePart.pos; i++)
            {
                ...
                {
                    Console.WriteLine($"Out of bounds! {pos.X},{pos.Y}");
                }
        ...
        private Pos2 Check(Pos2 from, Wire wirePart)
        {
            ...
            for(int i = 0; i < wirePart.pos; i++)
            {
                ...
                if(_grid[pos.X, pos.Y])
                {
                    ...
                    if(dist < MinManhattanDist) MinManhattanDist = dist;

                    var total = _distances[pos.X, pos.Y] + _distance;
                    if(total < MinTotDist) MinTotDist = total;
                }
            }
            return pos;
        }
